...
const animalObject = {
    "id": 21, 
    "type": "PW", 
    "name": "PW",  //def de nuevo elemento a añadir
    "habitat": "in2222", 
    "image": "https://loremflickr.com/640/480/sfssf?lock=1803067255160832"
};

const addAnimal = async (page, animalObject) => {   //CAREFUL: page needs to be used. ALSO, NO {}
