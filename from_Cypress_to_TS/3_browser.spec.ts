...
test.describe('Browser Demo @browser', () => {
    ...
    test('Browser demo', async ({ page, browserName }: { page: Page; browserName: string }) => {
    ...
    test('DOM', async ({ page }: { page: Page }) => { //puedes consultar propiedades booleanas - verdadero/falso de elementos del DOM
